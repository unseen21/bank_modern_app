    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          voluptatum debitis alias atque adipisci maxime voluptate quidem
          aliquid suscipit placeat reiciendis quae mollitia fuga assumenda,
          omnis ipsam ratione earum? Commodi!
        </p>
